...
export enum DICT_TYPE {
  ...
  // ========== Supervision - 监管模块  ==========
  SUPERVISION_CANTEEN_BUSINESS_STATUS = 'supervision_canteen_business_status', // 食堂营业状态
  SUPERVISION_CANTEEN_TODAY_MEAL_STATUS = 'supervision_canteen_today_meal_status', // 今日供餐状态
  SUPERVISION_WORKER_STATUS = 'supervision_worker_status', // 工勤人员状态
  SUPERVISION_WORKER_ATTRIBUTE = 'supervision_worker_attribute', // 工勤人员属性
  SUPERVISION_ASSET_STATUS = 'supervision_asset_status', // 固定资产状态
  SUPERVISION_ASSET_OPERATION_TYPE = 'supervision_asset_operation_type', // 固定资产操作类型
  SUPERVISION_TRAINING_LEVEL = 'supervision_training_level', // 培训级别
  SUPERVISION_REWARD_TYPE = 'supervision_reward_type', // 奖惩类型
